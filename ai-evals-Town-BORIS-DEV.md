...
*I build the systems that measure and improve LLM & agent quality: LLM-as-judge pipelines, ground-truth & golden datasets, eval harnesses, fault taxonomies, and observability. I audit the graders. PhD, Quantitative research.*
