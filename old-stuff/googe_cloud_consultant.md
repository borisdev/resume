...
-   **Data Analytics:** SQL, Python, SQLAlchemy, Pandas, PySpark, Git, GeoSpatial Stats & Maps, Social Science Data, Tableau
-   **Infra:** Prometheus, Grafana, Splunk, ELK, Docker, Kubectl, Distributed Tracing
...
-   **Langauge AI:** LangChain, PydanticAI, InstructorAI, LLMs (OpenAI, Anthropic, Gemini), LangSmith, Prompt Engineering, Embedding DBs (Weaviate, ElasticSearch), Fine-tuning base with hard examples in Sentence Transformers
