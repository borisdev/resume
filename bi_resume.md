...
-   **BI Tools:** Tableau, SQL, Pandas, Social Science Data Analysis and Modeling, Grafana, Splunk
-   **Engineering:** Data modeling, Python, Javascript, REST API Frameworks, Docker, AWS, CI/CD, Observability
